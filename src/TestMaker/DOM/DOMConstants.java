...
public interface DOMConstants {
    ...
    String QUESTION_XML_TAG = "Question";
    String QUESTIONS_XML_TAG = "Questions";
    ...
    String VARIANT_TEXT_TAG = "text";
    String ANSWER_VARIANTS_TAG = "answerVariants";
    String CORRECT_ANSWERS_TAG = "severalCorrectAnswers";
    String QUESTION_SCORE_TAG = "score";
